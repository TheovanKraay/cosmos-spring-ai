...
arguments:
  ...
  version:
    ...
    required: true
    description: >
      Version to release following semver (X.Y.Z, X.Y.Z-beta.N, X.Y.Z-MN, or X.Y.Z-RCN), e.g.
      1.0.0-beta.1, 1.0.0-M1, 1.0.0-RC1, 1.0.0.
  date:
    type: string
    required: false
    default: today
...
- After a release candidate `X.Y.Z-RCN` → `X.Y.Z-RC(N+1)-SNAPSHOT` or
  `X.Y.Z-SNAPSHOT` (depends on whether more RCs are planned)
